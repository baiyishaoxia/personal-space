<?php
/* Smarty version 3.1.29, created on 2018-05-14 17:34:28
  from "D:\php\BK\App\Back\View\Manage\index.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5af958248b1ad7_55275310',
  'file_dependency' => 
  array (
    '0bdf8f5e001b23782fec2af69c96577b661d5ba6' => 
    array (
      0 => 'D:\\php\\BK\\App\\Back\\View\\Manage\\index.html',
      1 => 1526290459,
      2 => 'file',
    ),
  ),
...
function content_5af958248b1ad7_55275310 ($_smarty_tpl) {
...
<br />
                    上线时间:<?php echo smarty_modifier_date_format((time()),'%Y-%m-%d %H:%M:%S');?>
...
次登录，上次登录时间为<?php echo smarty_modifier_date_format(($_SESSION['adminInfo']['login_time']),'%Y-%m-%d %T');?>
，上次登录的IP为<?php echo $_SESSION['adminInfo']['login_ip'];?>
        ...
        <div class="xm9">
            <div class="alert">
            	...
            	<a target="_blank" class="button bg-dot icon-code" href="#"> 空间后台</a> 
            	<a target="_blank" class="button bg-main icon-download" href="#"> 基于MVC框架</a> 
            	<a target="_blank" class="button border-main icon-file" href="#"> 基于MVC框架</a>
            </div>
            <div class="panel">
...
</td><td align="right">演示：</td><td><a href="http://tzf.afu666.xyz:81/" target="_blank">系统线上演示</a></td></tr>
