<?php
/* Smarty version 3.1.29, created on 2018-03-29 00:26:45
  from "/www/wwwroot/tzf.afu666.xyz/App/Home/View/User/user_modify.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5abbc2456ca7b9_64163104',
  'file_dependency' => 
  array (
    '72fc73a4056dc3a96cb3c60433519ef37ab5d520' => 
    array (
      0 => '/www/wwwroot/tzf.afu666.xyz/App/Home/View/User/user_modify.html',
      1 => 1520770062,
      2 => 'file',
    ),
  ),
...
function content_5abbc2456ca7b9_64163104 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
...
<div class="loginbox">
    <div class="login-content">
      ...
      <form name="theform" method="POST" action="index.php?p=Home&c=User&a=dealModify" enctype="multipart/form-data">
      <div class="login-error"></div>
      <div class="row">
        <input type="text" class="input-text-user input-click" name="user_name" id="username" placeholder="*请填写您注册的用户名" required="required"/>
      </div>

      <div class="row">
        <input type="email" class="input-text-user input-click" name="user_email" id="user_email" required="required" placeholder="*请输入您注册的邮箱" />
      </div>
      <div class="row btnArea">
        <input type="submit" value="下一步" class="login-btn" id="submit">
      </div>
      </form>
    </div>
  </div>
